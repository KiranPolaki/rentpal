...
export default function App() {
  return (
    <footer className="bg-neutral-100 text-center text-bl-600 dark:bg-black-600 dark:text-white-200 lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              ...
              rent anything they need with ease. The platform is built with the
              latest technologies, ensuring a seamless and user-friendly
              experience.
            </p>
          </div>
          {/* <!-- Products section --> */}
          <div className="">
            ...
            <p className="mb-4">
              <a
                className="text-white-600 dark:text-white-200"
          ...
          {/* <!-- Contact section --> */}
          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start"></h6>
